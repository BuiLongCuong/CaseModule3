      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="http://localhost:8080/posts?action=home">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://localhost:8080/posts?action=create">Create Post</a>
          </li>
...
<c:forEach var="item" items="${postList}">
        <div class="card mt-3" style="width: 80%;margin-left: 10% ">
          <div class="row">
            ...
            <div class="col-1"></div>
            <div class="col-6">
              <button style="border-radius: 20px 20px 20px 20px;float: right"><a href="http://localhost:8080/posts?action=update&id=${item.id}">Edit post <i class="fa-solid fa-pen-to-square"></i></a></button>
              <button style="border-radius: 20px 20px 20px 20px;float: right"><a href="http://localhost:8080/posts?action==delete&id=${item.id}">Delete post <i class="fa-solid fa-trash"></i></a></button>
            </div>
          </div>
